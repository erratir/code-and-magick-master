...
(function () {
   ...
   */
  let Wizard = function () {
    this.name = `${window.utils.getRandomElement(DataWizards.WIZARD_NAMES)} ${window.utils.getRandomElement(DataWizards.WIZARD_SURNAME)}`;
    this.coatColor = window.utils.getRandomElement(DataWizards.COAT_COLOR);
    this.eyesColor = window.utils.getRandomElement(DataWizards.EYES_COLOR);
  };
  ...
  wizardCoat.addEventListener(`click`, function () {
    let coatColor = window.utils.getRandomElement(DataWizards.COAT_COLOR);
    wizardCoat.style.fill = coatColor;
    wizardCoatInput.value = coatColor;
  });
  wizardEyes.addEventListener(`click`, function () {
    let eyesColor = window.utils.getRandomElement(DataWizards.EYES_COLOR);
    wizardEyes.style.fill = eyesColor;
    wizardEyesInput.value = eyesColor;
  });
  wizardFireball.addEventListener(`click`, function () {
    let fireballColor = window.utils.getRandomElement(DataWizards.FIREBALL_COLOR);
